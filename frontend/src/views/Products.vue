      ...
      <div class="flex items-center space-x-4">
        ...
        <div class="relative">
          <button
            ...
            class="border border-gray-300 rounded-md px-3 py-2 pr-3 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 bg-white text-left w-full flex items-center justify-between"
          >
